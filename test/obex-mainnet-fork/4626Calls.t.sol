...
contract SUSDSTestBase is ForkTestBase {
    ...
    function setUp() override public {
        ...
        assertEq(SUSDS_CONVERTED_ASSETS, 1071355916414951525, "SUSDS_CONVERTED_ASSETS");
        assertEq(SUSDS_CONVERTED_SHARES, 933396628215086689, "SUSDS_CONVERTED_SHARES");

        assertEq(SUSDS_TOTAL_ASSETS, 2585736487619507590772585933, "SUSDS_TOTAL_ASSETS");
        assertEq(SUSDS_TOTAL_SUPPLY, 2413517718996769632627012967, "SUSDS_TOTAL_SUPPLY");
    }
